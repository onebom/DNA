...
class ObjectCountingAPI:
    ...
    def count_objects_on_image(self, count, frame, tracker, memory, line_begin, line_end, targeted_classes=[], output_path="./the_output.avi", show=True):
        ...
        cv2.putText(frame, str(count_num), LINE_COUNTER_POSITION, LINE_COUNTER_FONT, LINE_COUNTER_FONT_SIZE,
                    LINE_COLOR, 2)
...
if __name__ == '__main__':
    ...
    counter.count_objects_crossing_the_virtual_line(cap, line_begin=(100, 300), line_end=(300, 300), show=True)
